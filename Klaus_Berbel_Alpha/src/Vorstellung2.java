...
public class Vorstellung2 {
	...
	public static void main(String[] args) throws IOException {
		...
		try {FileReader f0 = new FileReader("Namensliste.txt");
	        ...
	        while ((line = f.readLine()) != null) {
	        		...
	        		if(person[0].equals(vorname)){
	    				...
	    				if(person[2].equals("nein")||person[2].equals("Nein")){geschlecht = "männlich";}
	    				...
	    				if(namenszähler>1){
		    				...
		    				nachname = eingabe2;int namenszähler2 = 0;
		...
		if(namenszähler == 1){
			...
			if(eingabe2.equals("nein")){namenszähler = 0;}
			else{
		...
		if(namenszähler == 0){
			...
			geschlecht = eingabe3;int namenszähler3 = 0;
			
			if(geschlecht.equals("ja")||geschlecht.equals("Ja")){geschlecht = "weiblich";}
			if(geschlecht.equals("nein")||geschlecht.equals("Nein")){geschlecht = "männlich";}
			...
			herkunftsland = eingabe4;int namenszähler4 = 0;
			...
			try {in.newLine();
				...
				if(geschlecht.equals("weiblich")){gegengeschlecht="männlich";}
				if(geschlecht.equals("männlich")){gegengeschlecht="weiblich";}
	...
	private static void Klaus_Berbel() throws IOException {
		...
		// Wortschatz wird an internen Vektor übergeben
			    ...
			    System.out.println("Erzähle mir etwas!");
				...
				for(int i=0;i>-1;i++){
					...
					if(wortbekannt == satzwörter.length){
						...
						if(satzmatrix[0][10].equals("Prädikat")||satzmatrix[0][1].equals("Fragewort")||(satzmatrix[1][1].equals("Fragewort")&&satzmatrix[0][1].equals("Präposition"))){
							...
							if(antwortgefunden == false){
								...
								for(int y = 1; y < z3 ;y++){
									...
									zähler = 1;fragen = new String[999999];
						...
						//}
								...
								if(satzmatrix[a][1].equals("Substantiv")||satzmatrix[a][1].equals("Adjektiv")){
									...
									if(a>0){
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("der")){
											if(satzmatrix[a][4].equals("feminim")){
												...
												satzmatrix[a][11]="Hauptsatz";satzmatrix[a-1][11]="Hauptsatz";}
													...
													satzmatrix[a][11]="Hauptsatz";satzmatrix[a-1][11]="Hauptsatz";
													if(a>2){
														if(satzmatrix[a-2][1].equals("Präposition")){satzmatrix[a-2][7]="gendat";}
													}
												}
										...
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("dem")){
											...
											if(a>2){
												if(satzmatrix[a-2][1].equals("Präposition")){satzmatrix[a-2][7]="dativ";}
											}
											if(satzmatrix[a][11].equals("Hauptsatz")){hsobjfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz1")){ns1objfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz2")){ns2objfound=true;}
										...
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("den")){
											...
											if(a>2){
												if(satzmatrix[a-2][1].equals("Präposition")){satzmatrix[a-2][7]="akkusativ";}
											}}
											if(satzmatrix[a][11].equals("Hauptsatz")){hsobjfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz1")){ns1objfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz2")){ns2objfound=true;}
									...
									if(a>1){
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("Adjektiv")&&satzmatrix[a-2][0].equals("der")){
											if(satzmatrix[a][4].equals("feminim")){
												...
												satzmatrix[a][11]="Hauptsatz";satzmatrix[a-1][11]="Hauptsatz";satzmatrix[a-2][11]="Hauptsatz";}
													...
													satzmatrix[a][11]="Hauptsatz";satzmatrix[a-1][11]="Hauptsatz";satzmatrix[a-2][11]="Hauptsatz";
													if(a>3){
														if(satzmatrix[a-3][1].equals("Präposition")){satzmatrix[a-2][7]="gendat";}
													}
												}
										...
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("Adjektiv")&&satzmatrix[a-2][0].equals("dem")){
											...
											if(a>3){
												if(satzmatrix[a-3][1].equals("Präposition")){satzmatrix[a-2][7]="dativ";}
											}
											if(satzmatrix[a][11].equals("Hauptsatz")){hsobjfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz1")){ns1objfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz2")){ns2objfound=true;}
										...
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("Adjektiv")&&satzmatrix[a-2][0].equals("den")){
											...
											if(a>3){
												if(satzmatrix[a-3][1].equals("Präposition")){satzmatrix[a-2][7]="akkusativ";}
											}}
											if(satzmatrix[a][11].equals("Hauptsatz")){hsobjfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz1")){ns1objfound=true;}
											if(satzmatrix[a][11].equals("Nebensatz2")){ns2objfound=true;}
							...
							String hspräposition2 = "";
							String ns1konjunktio = "";
							boolean hspräpo = false;
							...
							for (int a=0; a<satzwörter.length; a++){
							if(satzmatrix[a][1].equals("Präposition")&&satzmatrix[a][11].equals("Hauptsatz")){hspräpo = true;hspräposition2=satzmatrix[a][0];}
							...
							boolean wahreaussage = false;
								...
								for(int y = 1; y < z3 ;y++){
									...
									int zähler2 = 1;String[] fragen2 = new String[999999];
									//System.out.println(dateiname[y]);
											...
											try {FileReader f1 = new FileReader(dateiname[y]+".txt");
										        ...
										        while ((line = ff1.readLine()) != null) {
										        	...
										        	if(line.equals(hssprädikat+hssubjekt+hsobjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat+" : Ja")){posbinom++;}
										        	if(line.equals(hssprädikat+hssubjekt+hsobjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat+" : Nein")){negbinom++;}
								...
								if(t>1.28){
									wahreaussage = true;
									System.out.println("Ich denke diese Aussage könnte wahr sein.");
								}
							...
							int boleanzähler = 1;String[] bolfragen = new String[999999];
							...
							if(fragegefunden2==false){
								...
								try {
									...
									try {
										in.write(hssprädikat+hssubjekt+hsobjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat+" : Ja");aussageneu = true;
										in.newLine();
										// Versuch
										if(hsnicht==true){
											in.write(hssprädikat+hssubjekt+nichthsobjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat+" : Nein");aussageneu = true;
											in.newLine();
										}
										int zz = 1;
										if(ichpro2==true){
											...
											try {
										        ...
										        while ((line = f.readLine()) != null) {
										        		...
										        		String[] wortwörter = wort[zz].split("\\s");
										        		
														if (hssprädikat.equals(" "+wortwörter[0])) {
															if (wortwörter[2].equals("erste")) {
																String[] wortwörter2 = wort[zz+2].split("\\s");
																prädi = " "+wortwörter2[0];
															}
														}
											...
											for(int a=0; a<wort.length;a++){
												String[] wortwörter = wort[a].split("\\s");
												if (hssprädikat.equals(" "+wortwörter[0])) {
													if (wortwörter[2].equals("erste")) {
														String[] wortwörter2 = wort[a+2].split("\\s");
														hssprädikat = " "+wortwörter2[0];
													}
												}
											}
											**/
											
											in.write(" wer"+prädi+hsobjekt+" : "+vorname+" "+nachname);
											in.newLine();
											in.write(" was"+prädi+hsobjekt+" : "+vorname+" "+nachname);
											in.newLine();
										}
										else{
											in.write(" wer"+prädi+hsobjekt+" :"+hssubjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
											in.newLine();
											in.write(" was"+prädi+hsobjekt+" :"+hssubjekt+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
											in.newLine();
										}
							...
							if(hsobjektgendatf == true){
								...
								for(int b=1;b<boleanzähler;b++){
									if(bolfragen[b].equals(hspräposition+" wem"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals(hspräposition+" wem"+hssprädikat+khssubjekt+khsobjektnom+" :"+khsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals(hspräposition+" wessen"+hsobjektohneartikel+hssprädikat+hssubjekt+" :"+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)){
										fragegefunden2 = true;
									}
								}
									...
									try {
										...
										try {
											...
											if(hsein==true){
												...
												in.write(hspräposition+" wem"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
												in.newLine();
												in.write(hspräposition+" wessen"+hsobjektohneartikel+hssprädikat+" nicht"+hssubjekt+" :"+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
												in.newLine();
												in.close();
												in.close();
												...
												in.write(hspräposition+" wem"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
												in.newLine();
												in.write(hspräposition+" wessen"+hsobjektohneartikel+hssprädikat+hssubjekt+" :"+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
												in.newLine();
												in.close();
												in.close();
							...
							if(hspräpo == true){
								...
								for(int b=1;b<boleanzähler;b++){
									if(bolfragen[b].equals("woher"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektgendat+hsobjektdatakk+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("woher"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wo"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wo"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wo"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wo"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wohin"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektakk+hsobjektdatakk+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wohin"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektakk+hsobjektdatakk+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wohin"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektakk+hsobjektdatakk+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("wohin"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektakk+hsobjektdatakk+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("warum"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("weshalb"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("warum"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("weshalb"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)){
								...
								if(fragegefunden2==false){
									...
									try {
										...
										try {
											...
											if(hspräposition2.equals("ab")||hspräposition2.equals("aus")||hspräposition2.equals("von")){
												
												if(hsnicht==true){
													in.write("woher"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("woher"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
											...
											if(hspräposition2.equals("außer")||hspräposition2.equals("bei")||hspräposition2.equals("gegenüber")){
												
												if(hsnicht==true){
													in.write("wo"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("wo"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
											
											if(hspräposition2.equals("abseits")||hspräposition2.equals("außerhalb")||hspräposition2.equals("diesseits")||hspräposition2.equals("entlang")||hspräposition2.equals("inmitten")
													||hspräposition2.equals("innerhalb")||hspräposition2.equals("jenseits")||hspräposition2.equals("längs")||hspräposition2.equals("oberhalb")||hspräposition2.equals("unterhalb")||hspräposition2.equals("unweit")){
												
												if(hsnicht==true){
													in.write("wo"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("wo"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
											...
											if(hspräposition2.equals("an")||hspräposition2.equals("auf")
													||hspräposition2.equals("hinter")||hspräposition2.equals("in")||hspräposition2.equals("neben")||hspräposition2.equals("über")||hspräposition2.equals("unter")||hspräposition2.equals("vor")||hspräposition2.equals("zwischen")){
												
												if(hsnicht==true){
													in.write("wohin"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektakk+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("wo"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
													...
													in.write("wohin"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektakk+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("wo"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
											...
											if(hspräposition2.equals("bis")||hspräposition2.equals("durch")
													||hspräposition2.equals("gegen")){
											...
											if(hspräposition2.equals("nah")||hspräposition2.equals("zu")){
												
												if(hsnicht==true){
													in.write("wohin"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("wohin"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektdatakk+hsobjektgendat+hsobjektgen+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
											
											if(hspräposition2.equals("aufgrund")||hspräposition2.equals("wegen")){
												
												if(hsnicht==true){
													in.write("warum"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("warum"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektgen+hsobjektgendat+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
											
											if(hspräposition2.equals("um")){
												
												if(hsnicht==true){
													in.write("warum"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektgendat+hsobjektdatakk+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+" nicht"+hsobjektnom+" :"+hsobjektdat+hsobjektgendat+hsobjektdatakk+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("warum"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektgendat+hsobjektdatakk+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+hsobjektnom+" :"+hsobjektdat+hsobjektgendat+hsobjektdatakk+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
							...
							if(ns1konju == true){boolean fragegefunden3 = false;
								...
								for(int b=1;b<boleanzähler;b++){
									if(bolfragen[b].equals("warum"+hssprädikat+hssubjekt+" nicht"+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)||
											bolfragen[b].equals("warum"+hssprädikat+hssubjekt+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat)){
									...
									try {
										...
										try {
											...
											if(ns1konjunktio.equals("weil")){
												...
												if(hsnicht==true){
													in.write("warum"+hssprädikat+hssubjekt+" nicht"+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+" nicht"+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}
												else{
													
													in.write("warum"+hssprädikat+hssubjekt+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.write("weshalb"+hssprädikat+hssubjekt+hsobjekt+" :"+ns1konjunktion+ns1subjekt+ns1objekt+ns1prädikat+ns2konjunktion+ns2subjekt+ns2objekt+ns2prädikat);
													in.newLine();
													in.close();
												}	
											}
						...
						if(aussageneu == true){
							...
							for(int y = 1; y < z3 ;y++){
								...
								int zähler2 = 1;String[] fragen2 = new String[9999999];
								//System.out.println(dateiname[y]);
								...
								if(antwort2.equals("ja")){
									...
									if(letzter.equals("e")){//System.out.println("Ist das Verb erste Person Singular?");
										for(int a =0; a<c.length-1; a++){
											...
											if(vorletzter.equals("s")||vorletzter.equals("ß")||vorletzter.equals("z")){
												ender = 1;
											}
									...
									if(letzter.equals("t")){//System.out.println("Ist das Verb dritte Person Singular oder zweite Person Plural?");
										for(int a =0; a<c.length-1; a++){
											verbstamm2 = verbstamm+c[a];
											verbstamm = verbstamm2;
											if(vorletzter.equals("ß")||vorletzter.equals("z")){
												ender = 1;
											}
										}
									}
									if(vorletzter.equals("e")&&letzter.equals("n")){//System.out.println("Ist das Verb erste oder dritte Person Plural?");
										for(int a =0; a<c.length-2; a++){
											verbstamm2 = verbstamm+c[a];
											verbstamm = verbstamm2;
											if(vorvorletzter.equals("s")||vorvorletzter.equals("ß")||vorvorletzter.equals("z")){
												ender = 1;
											}
									...
									if(antwort3.equals("ja")){System.out.println("Ich habe ein neues Wort gelernt.");	
										...
										try {in.newLine();
												...
												if(ender == 1){
													in.write(verbstamm+"e Verb erste singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													//in.write(verbstamm+"t Verb zweite singular - indikativ präsens - finit nein kA kA");
													//in.newLine();
													in.write(verbstamm+"t Verb dritte singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"en Verb erste plural - indikativ präsens - finit nein kA kA");
													in.newLine();
													//in.write(verbstamm+"t Verb zweite plural - indikativ präsens - finit nein kA kA");
													//in.newLine();
													//in.write(verbstamm+"en Verb dritte plural - indikativ präsens - finit nein kA kA");
													//in.newLine();
												}
												else if(ender == 2){
													in.write(verbstamm+"e Verb erste singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"est Verb zweite singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"et Verb dritte singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"en Verb erste plural - indikativ präsens - finit nein kA kA");
													in.newLine();
													//in.write(verbstamm+"et Verb zweite plural - indikativ präsens - finit nein kA kA");
													//in.newLine();
													//in.write(verbstamm+"en Verb dritte plural - indikativ präsens - finit nein kA kA");
													//in.newLine();
												}
													...
													in.write(verbstamm+"e Verb erste singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"st Verb zweite singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"t Verb dritte singular - indikativ präsens - finit nein kA kA");
													in.newLine();
													in.write(verbstamm+"en Verb erste plural - indikativ präsens - finit nein kA kA");
