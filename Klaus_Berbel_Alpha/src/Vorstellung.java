				...
				for(int i=0;i>-1;i++){
					...
					if(wortbekannt == satzwörter.length){
						...
						if(satzmatrix[0][10].equals("Prädikat")||satzmatrix[0][1].equals("Fragewort")||(satzmatrix[1][1].equals("Fragewort")&&satzmatrix[0][1].equals("Präposition"))){
							...
							if(antwortgefunden == false){
								...
								for(int y = 1; y < z3 ;y++){
									...
									zähler = 1;fragen = new String[9999999];
						...
						//}
										...
										if(satzmatrix[a][1].equals("Substantiv")&&satzmatrix[a-1][0].equals("der")){
											if(satzmatrix[a][4].equals("feminim")){
												...
												satzmatrix[a][11]="Hauptsatz";satzmatrix[a-1][11]="Hauptsatz";}
													...
													//if(satzmatrix[a][11].equals("Hauptsatz")){gendatfound=true;}
													//if(satzmatrix[a][11].equals("Nebensatz1")){gendatfound=true;}
													//if(satzmatrix[a][11].equals("Nebensatz2")){gendatfound=true;}
												}
							...
							try { FileReader f1 = new FileReader("Antworten.txt");
							if(ichpro2 == true){f1 = new FileReader(vorname+"_"+nachname+".txt");}
							else{f1 = new FileReader("Antworten.txt");}
						        BufferedReader ff1 = new BufferedReader(f1);
						        String line;
							...
							if(fragegefunden2==false){
								...
								try {
									...
									if(ichpro2==true){in = new BufferedWriter(
									        new OutputStreamWriter(
								...
								if(satzmatrix[wortunbekanntpos-1][1].equals("Artikel")){
									...
									if(antwort.equals("ja")){
										...
										if(satzmatrix[wortunbekanntpos-1][0].equals("ein")||satzmatrix[wortunbekanntpos-1][0].equals("einem")||satzmatrix[wortunbekanntpos-1][0].equals("eines")||
												satzmatrix[wortunbekanntpos-1][0].equals("kMaein")||satzmatrix[wortunbekanntpos-1][0].equals("keinem")||satzmatrix[wortunbekanntpos-1][0].equals("keines")){
